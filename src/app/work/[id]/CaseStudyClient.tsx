        ...
        >
          ...
          <div style={{ display: "grid", gridTemplateColumns: "55fr 45fr", gap: "48px", alignItems: "start" }}>
            ...
            {project.researchVideo ? (
              <div style={{ aspectRatio: "4 / 3", borderRadius: "16px", overflow: "hidden", backgroundColor: "#E8E4DC", padding: "32px", boxSizing: "border-box" }}>
                <video
                  ...
                  >
                    {scrollSrc ? (
                      <div
                        className="ve-scroll"
                        style={ci === 0
                          ? { width: "100%", height: "560px", overflow: "hidden", padding: "0", boxSizing: "border-box" }
                      ...
                      >
                        <Image
                          ...
                          sizes="(max-width: 768px) 100vw, 45vw"
                          style={ci === 0
                            ? { width: "100%", height: "100%", objectFit: "cover", objectPosition: "center 88%", display: "block" }
