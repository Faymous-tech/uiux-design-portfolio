...
export const projects: Project[] = [
  ...
  },
  {
    ...
    moreFlowsImage2: "/images/nanaade/nanaade-moreflows-4.jpg",
  ...
  },
  {
    ...
    research: "The research phase focused on how people actually shop for streetwear online — what pulls them in, what makes them bounce, and why so much of the category feels interchangeable. We studied editorial fashion houses against typical e-commerce, and the contrast was stark: most streetwear sites sell through urgency — countdowns, clutter, constant discounts — training shoppers to chase the next drop instead of valuing the piece in front of them. Talking to the kind of customer Addicto is built for surfaced the real insight: they don't want to be sold to, they want to feel like they've found something. That reframed the brief. The opportunity wasn't louder marketing — it was restraint: the site had to earn trust the way the clothing does, treating every piece as considered and worth keeping, not a deal to grab before it's gone.",
  ...
  },
  {
    ...
    research: "The research phase focused on how people actually train at home — what makes them start, what makes them quit, and why so many abandon form-based workouts without a coach. We studied existing fitness apps against the experience of working with a real personal trainer, and the gap was stark: most apps just play a video and trust you to copy it, with no idea whether you're doing it right. Talking to home exercisers surfaced two anxieties again and again — fear of hurting themselves with bad form, and self-consciousness about being watched or judged. That reframed the brief. People didn't need more workout content; they needed a coach that could see them and correct them privately, in real time. Two things became non-negotiable: feedback had to feel encouraging rather than critical, and everything had to run on-device, so users could trust pointing a camera at themselves.",
